...
Si scriva un programma (il file deve chiamarsi 'sinonimi.go') che gestisca come spiegato qui di seguito
l'implementazione di un dizionario dei sinonimi da applicare ad un testo.

Il programma dovrà lavorare su due file di testo, i cui nomi verranno passati a riga di comando,
il primo conterrà il dizionario dei sinonimi, il secondo il testo da elaborare (privo di punteggiatura).
