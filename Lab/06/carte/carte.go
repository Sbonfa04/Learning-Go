...
Se avete una versione vecchia di Go, per generare sequenze sempre diverse, importare il pacchetto "time" e usare l'istruzione rand.Seed(time.Now().Unix()) prima di iniziare a generare numeri casuali. Altrimenti non occorre.
*/
